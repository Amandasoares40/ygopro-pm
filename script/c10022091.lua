...
--[[
	Rulings
		...
		Q. If I use "Surprise Time Machine" and choose the same Evolution card that I shuffled into my deck, can I use
		that card's Pokémon powers even if I've already used it up for the turn (i.e. Blaziken's "Firestarter")?
		A. Unless it's a power that specifically says you may only use one of that power (overall) per turn, then yes that
		is permissible. (Nov 18, 2004 PUI Rules Team)

		Q. If you play Surprise! Time Machine on a Wobbuffet that was evovled from a Wynaut via "Baby Evolution", what
		happens after you shuffle the Wobbuffet back into your deck?
		A. Since there is not a normal evolution path from Wynaut to Wobbuffet (without using "Baby Evolution"), you
		cannot take a Wobbuffet from your deck to evolve it again.

		Q. Lets say I have like a Kirlia active with a DRE [Double Rainbow Energy] on it, and then use "Suprise! Time
		Machine" for a different Kirlia. Would the DRE get discarded because it is devolved back into Ralts?
		A. Yes, once it becomes a Ralts, it is discarded. It doesn't matter that it will evolve again.
		(Jan 13, 2005 PUI Rules Team)

		Q. If I use "Surprise! Time Machine" and remove a Stage 2 Pokémon that was evolved from a Basic using Rare Candy,
		do I search for a Stage 2 Pokémon card or a Stage 1 card?
		A. You can only search for a Stage 1 card, because when you remove the Stage 2 what you have in play is Basic
		Pokémon. (Feb 10, 2005 PUI Rules Team)

		Q. If I use "Surprise! Time Machine" and remove a Stage 2 Pokémon that was evolved from a Basic using Rare Candy,
		can I search for a Stage 1 Pokémon card and then evolve it using Wally's Training or Rare Candy?
