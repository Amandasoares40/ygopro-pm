...
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	...
	if c:IsCanRemoveCounter(tp,COUNTER_DAMAGE,2,REASON_EFFECT) and Duel.SelectYesNo(tp,YESNOMSG_REMOVECOUNTER) then
		c:RemoveCounter(tp,COUNTER_DAMAGE,2,REASON_EFFECT)
	end
