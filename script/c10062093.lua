...
--[[
	Rulings
		Q. When Dimension Valley is in play, if Mew EX uses its "Versatile" Ability to copy an attack from another
		Pokemon, will the attack's Energy cost be reduced by (C)?
		...
		A. No. When Versatile copies the attack it uses the original attack cost regardless of the opponent's Pokemon's
		type, and then Dimension Valley reduces the cost by (C) since Mew EX is Psychic. (Nov 20, 2014 TPCi Rules Team)
