...
--[[
	Rulings
		...
		Q. When you use Pokémon Trader, do you have to trade a basic for a basic, stage 1 for stage 1 etc. or can you
		trade any Pokémon for any stage?
		...
		A. The card says to 'trade', if you can't do that don't put the card from your hand into your deck. You could
		still play the Trainer BUT you would NOT be able to trade so you would NOT put a Pokémon from your hand into your
		deck. (Nov 16, 2000 WotC Chat, Q142 & Q143)
		https://compendium.pokegym.net/compendium.html#trainers

		Q. Is there a difference between "trading" your cards such as Energy Retrieval and "discarding" your cards such as
		an Item Finder? Say that I only have one Energy in my discard pile, and I use Energy Retrieval using Energy to
		trade, You only are able to retrieve the Energy in your discard pile, not the card you traded. Right? Cause it
		would make sense about "trading".
		A. Yes, that's right. (Mar 2, 2000 WotC Chat)
		http://compendium.pokegym.net/compendium-lvx.html#34
]]
