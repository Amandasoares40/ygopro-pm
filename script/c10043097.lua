...
--[[
	Rulings
		...
		deck?
		A. No, because Pokemon Collector only lets you choose Basic Pokemon. Pokemon LEGEND are considered "Unevolved
		Pokemon" when in play, but they are not considered "Basic Pokemon".
		(GS:Heart Gold/Soul Silver FAQ; Feb 11, 2010 PUI Rules Team)
		http://compendium.pokegym.net/compendium-bw.html#163
	Note: This card's effect is almost identical to that of "Pokemon Collector".
]]
