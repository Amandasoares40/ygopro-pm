...
--[[
	...
	A. Since Pikachu would be considered an "Evolved Pokémon" at that point, Rare Candy cannot be used on that Pikachu.
	Rare Candy can only be used on "non-Evolved" Pokémon. (Apr 14, 2005 PUI Rules Team)

	Q. If you use Rare Candy to evolve a Pokémon, and the evo card has a "Coming into Play" Pokémon Power (such as Dark
	Crobat), does that coming into play power get activated?
	...
	Q. Can you use Rare Candy to evolve a Mysterious Fossil into an Omastar or Kabutops, or use it on a Root/Claw Fossil
	to evolve into Cradily/Armaldo?
	A. It can. It counts as a basic Pokémon while in play. Omastar, Kabutops, Cradily, and Armaldo are Stage 2 Pokémon;
	you could use Rare Candy on the Fossil trainer to skip to them. (Oct 16, 2003 PUI Rules Team)

	Q. Can I use Rare Candy to evolve a Baby Pokémon into its next stage? What about the newer forms of babies that are
	considered "Basic Pokémon" but have the "Baby Evolution" Poké-POWER?
	A. Rare Candy states if you have a card that "Evolves From" your Pokémon There are currently no cards with text saying
	"evolves from" its baby form, so Rare Candy will not work on any form of baby Pokémon
	...
	A. No, you may not. Just like you cannot use Rare Candy to attach a Stage 1 then evolve it into a Stage 2 on the same
	turn, you cannot place a LV.X Pokémon on top of a Pokémon that used Rare Candy on that same turn.
	(May 31, 2007 PUI Rules Team)
	https://compendium.pokegym.net/compendium-lvx.html#567
]]
