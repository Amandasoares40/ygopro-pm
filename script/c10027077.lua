--Strange Cave (Legend Maker 77/92)
...
function scard.tbfilter(c,e,tp)
	return c:IsCode(CARD_OMANYTE,CARD_KABUTO,CARD_AERODACTYL,CARD_AERODACTYL_EX_OLD,CARD_LILEEP,CARD_ANORITH)
		and c:IsCanBePlayed(e,0,tp,true,false)
end
