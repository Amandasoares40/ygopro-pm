--Dome Fossil (Majestic Dawn 89/100)
...
scard.evolution_list1={["Basic"]=CARD_DOME_FOSSIL,["Stage 1"]=CARD_KABUTO_MD67,["Stage 2"]=CARD_KABUTOPS}
--poke-body (search - evolve)
function scard.cfilter(c,tc)
	return c:IsEnergy(ENERGY_F) and c:IsPlayedFromHand() and c:GetAttachedTarget()==tc
end
