...
--[[
	Rulings
	* Poké-Powers that end your turn are receiving errata to make it clear that you still end your turn if the Poké-Power
	is canceled, such as with Team Galactic's Invention G-103 Power Spray or by Alakazam's "Power Cancel" Poké-Power.
	...
	A. Yes. Only the player going first is restricted from playing Trainers, Supporters, and Stadiums. The opponent is not
	restricted. (Feb 26, 2009 PUI Rules Team)
	https://compendium.pokegym.net/compendium-lvx.html#355
]]
