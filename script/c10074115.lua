...
--[[
	Rulings
		...
		A. No, you cannot. If the opponent doesn't have a bench there's no way to do the second part of the trainer, and
		you cannot play a Trainer card for no effect. (Aug 31, 2017 TPCi Rules Team)

		Q. If I use Guzma and choose my opponent's Primal Groudon-EX that has the "Omega Barrier" Ancient Trait, do I
		still get to switch my own Pokemon?
