...
function scard.tbfilter(c,e,tp)
	return c:IsBasicPokemon() and c:IsEnergyType(ENERGY_W+ENERGY_F) and c:IsCanBePlayed(e,0,tp,true,false)
end
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	if not e:GetHandler():IsRelateToEffect(e) or Duel.IsBenchFull(tp) then return end
