...
--[[
	Rulings
	Q. If I shuffle Rotom into my deck using "Charon's Choice", but I don't find any other Rotom, can I choose the same
	one and put it back?
	...
	choose any Rotom from your deck, even another Mow Rotom. When you switch, remove effects and Special Conditions from
	the new Rotom, but keep all damage counters and cards attached. (PL:Rising Rivals FAQ; May 21, 2009 PUI Rules Team)

	Q. If I use Sableye's "Impersonate" attack to search for a supporter and I find "Charon's Choice" and use its effect,
	does Charon's Choice go back into my hand at the end of my turn or do I discard it per Sableye's attack?
	A. When using Impersonate, the Charon's Choice card goes to the discard pile rather than next to the Active Pokemon.
	Since it is already in the discard pile, you cannot bring the Charon's Choice card back into your hand.
	(Jun 11, 2009 PUI Rules Team)
	https://compendium.pokegym.net/compendium-lvx.html#398
]]
