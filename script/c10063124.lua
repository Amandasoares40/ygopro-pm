...
function scard.tbfilter(c,e,tp)
	return c:IsPokemon() and c:IsEnergyType(ENERGY_W) and c:IsCanBePlayed(e,0,tp,true,false)
end
...
--[[
	...
	Q. With "Archie's Ace in the Hole" and "Maxie's Hidden Ball Trick", does a Stage 2 Pokemon put on the bench count as
	a Basic Pokemon?
	...
	https://compendium.pokegym.net/compendium-bw.html#388
]]
