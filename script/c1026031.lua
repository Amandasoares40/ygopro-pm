...
function scard.initial_effect(c)
	aux.AddSetcode(c,SETNAME_TEAM_MAGMA,SETNAME_BALL)
	--search (to hand)
...
function scard.thfilter1(c)
	return c:IsBasicPokemon() and c:IsSetCard(SETNAME_TEAM_MAGMA) and c:IsAbleToHand()
end
function scard.thfilter2(c)
	return c:IsBasicEnergy() and c:IsEnergy(ENERGY_F) and c:IsAbleToHand()
end
