...
--[[
	Rulings
		Q. If a Basic Pokemon was put into play last turn, can I use Evosoda on it twice to bring it all the way to a
		Stage 2?
		A. No, you cannot. When you evolve a Pokemon it is a new Pokemon, and since it was put into play this turn you
		cannot use Evosoda on it until next turn. (XY FAQ; Feb 6, 2014 TPCi Rules Team)
		...
		Q. Can I use Wally or Evosoda to search my deck for a card that is not in the current tournament format? For
		example, could I use it on Raichu to search for a Raichu BREAK after it rotates out?
		A. Yes, you can. Even though a card may not be in the tournament format it still exists and can be searched for
		even though it is known to fail. (Jul 26, 2018 TPCi Rules Team)
		...
		A. Yes, but be careful of the order in which you play the cards. Wally says you can use it on a Pokemon that was
		put into play this turn, but Evosoda says you cannot use it on a Pokemon that was put into play this turn. So you
		can play Evosoda first then Wally, but you cannot play Wally then Evosoda (on the same Pokemon, of course).
