--Cyclone Energy (Skyridge 143/144)
...
function scard.con1(e,tp,eg,ep,ev,re,r,rp)
	...
	return c:IsPlayedFromHand() and tc and tc:IsActive()
		and Duel.GetActivePokemon(1-ep) and Duel.GetBenchedPokemon(1-ep):GetCount()>0
end
function scard.op1(e,tp,eg,ep,ev,re,r,rp)
	Duel.Hint(HINT_CARD,0,e:GetHandler():GetOriginalCode())
	Duel.SwitchPokemon(1-ep,1-ep)
end
